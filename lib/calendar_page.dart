// ignore_for_file: unnecessary_const, constant_identifier_names, use_key_in_widget_constructors, unnecessary_new, prefer_const_constructors, annotate_overrides, library_private_types_in_public_api, sort_child_properties_last, deprecated_member_use, avoid_print
...
const d_green = Color.fromARGB(255, 248, 207, 2);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Divider(
          color: Color.fromARGB(255, 255, 177, 9),
          height: 1,
        ),
      ],
    );
